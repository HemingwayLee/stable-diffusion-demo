...
class Generation(Base):
    ...
    generation_type: Mapped[str] = mapped_column(String(10), nullable=False, default="txt2img", server_default="txt2img")
    strength: Mapped[float | None] = mapped_column(Float, nullable=True)
    input_image_filename: Mapped[str | None] = mapped_column(String(255), nullable=True)
